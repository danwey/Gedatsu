#
#  Be sure to run `pod spec lint Gedatsu.podspec' to ensure this is a
...
|  <img width="100%" src="https://github.com/bannzai/Gedatsu/blob/master/docs/autolayout.png" />  |  <img width="100%" src="https://github.com/bannzai/Gedatsu/blob/master/docs/gedatsu.png" />  |
  ...
  spec.author             = { "bannzai" => "kingkong999yhirose@gmail.com" }
  # Or just: spec.author    = "hirose yudai"
  # spec.authors            = { "hirose yudai" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/hirose yudai"
  ...
  spec.source_files  = "Sources/Gedatsu/*.swift"
